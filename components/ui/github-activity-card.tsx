            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                    ...
                    <a
                      ...
                      className="text-sm font-bold text-foreground hover:text-primary transition-colors underline decoration-primary/30 hover:decoration-primary underline-offset-2 truncate"
                    >
                      {activity.repo}
                    </a>
                  </div>
                ...
                <div className="flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <LucideIcons.ExternalLink className="w-4 h-4 text-primary" />
                </div>
              </div>
            );
          })}
